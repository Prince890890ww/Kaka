...
\x1b[1;97m===========================================================
\033[1;37m[*] OWNER      : \033[1;36mHASSAN AND DEVIL
\033[1;37m[*] STATUS     : \033[1;91mPERMIUM
\033[1;37m[*] TEAM       : HASSAN X DEVIL
\033[1;37m[*] TOOL       : AUTO CREATE FB ACC
\x1b[1;97m[*]==========================================================""")                                       
...
def CRTT():
    ...
    dn()
    line()
    print("\033[1;92m[COMPLETE-OK] "+random.choice(oks)+"\033[1;97m")
    line()
    dn()
